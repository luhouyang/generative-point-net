...
from src.pointnet2.models.shared import PointNetSetAbstractionMsg, PointNetSetAbstraction, PointNetFeaturePropagation
...
class PointNet2PartSegMSG(nn.Module):
    ...
    def forward(self, xyz, cls_label):
        ...
        l0_points = self.fp1(
            l0_xyz, l1_xyz, torch.cat([cls_label_one_hot, l0_xyz, l0_points],
                                      1), l1_points)
        # FC layers
...
class PointNet2PartSegMSGLoss(nn.Module):

    def __init__(self):
        super(PointNet2PartSegMSGLoss, self).__init__()
