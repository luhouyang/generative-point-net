...
def convert_off_to_ply(root_dir, split="train"):
    ...
    for class_name in class_names:
        input_folder = os.path.join(root_dir, class_name, split)  # train or test folder
        ...
        for file_name in os.listdir(input_folder):
            if file_name.endswith(".off"):
                ...
                output_file = os.path.join(output_folder, file_name.replace(".off", ".ply"))
...
# Set the path to your ModelNet40 dataset root folder
