...
import argparse
import os
from src.pointnet.model import PointNetSemSeg
from src.pointnet2.models.sem_seg import PointNet2SemSegMSG
from src.pointnet.dataset import ScannetDatasetWholeScene
from src.pointnet.preprocessing.s3dis.indoor3d_util import g_label2color
import torch
import logging
...
import src.pointnet.provider as provider
import numpy as np
...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, help='PATH/model.pth')
...
def main(args):
    ...
    experiment_dir = 'log_pointnet2/sem_seg/' + args.log_dir
    ...
    # classifier = PointNetSemSeg(num_class=NUM_CLASSES).cuda()
    classifier = PointNet2SemSegMSG(num_classes=NUM_CLASSES).cuda()
